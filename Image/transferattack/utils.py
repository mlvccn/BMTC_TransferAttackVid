...
def load_pretrained_model(cnn_model=cnn_model_paper, vit_model=[]):
...
class AdvDataset(torch.utils.data.Dataset):
    def __init__(self, input_dir=None, output_dir=None, targeted=False, eval=False, mixer_data_dir = None):
