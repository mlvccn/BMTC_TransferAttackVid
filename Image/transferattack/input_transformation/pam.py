...
class PAM(MIFGSM):
    ...
    def __init__(self, model_name, epsilon=8/255, alpha=0.8/255, epoch=10, decay=1., num_aug_path=8, num_scale=4, train_epoch=15, targeted=False, random_start=False, norm='linfty', loss='crossentropy', device=None, attack='PAM', **kwargs):
